    ...
    <section>
        ...
        <div style="text-align: center; width: 100%;">
            <div style=" width:19%; height:auto; float:left;">
                <img src="{{ $message->embed('assets/images/email-temp-06.1.png') }}" width="100%" style="vertical-align: top">
                <p style="font-size: 14px;">{{ trans('pi.contact_the_provider') }}</p>
            </div>
            <div style=" width:19%; height:20px; float:left;">
                &nbsp;
            </div>
            <div style="width: 19%; height: auto; float: left;">
                <img src="{{ $message->embed('assets/images/email-temp-07.1.png') }}" width="100%" style="vertical-align: top">
                <p style="font-size: 14px;">{{ trans('pi.location_activity') }}</p>
            </div>
            <div style=" width:19%; height:20px; float:left;">
                &nbsp;
            </div>
