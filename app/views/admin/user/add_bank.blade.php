...
@section('content')
        ...
        <div class="col-md-6 col-lg-8 col-sm-6">
            <div class="card">
                <div class="card-body">
                    <div class="box-login">
                        {{ Form::open(array('url' => 'user/store_bank/'.$user->id,'class' => 'form-horizontal','files' =>true)) }}
                        ...
                        <div class="tabbable-panel">
                            <div class="tabbable-line">
                                <ul class="nav nav-tabs ">
                                    <li class="active">
                                        <a href="#" data-toggle="tab"> {{ trans('provider.add_new_bank_account_for') }} <b>{{ $user->first_name.' '.$user->last_name }}</b> </a>
                                    </li>
                                </ul>
