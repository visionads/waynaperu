...
<script src="{{asset('assets/admin/js/libs/ckeditor/ckeditor.js')}}"></script>
...
<script src="{{ asset('assets/admin/js/core/demo/DemoFormEditors.js') }}"></script>--}}
...
{{-- For DataTable--}}
<script src="{{ asset('assets/admin/js/libs/DataTables/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('assets/admin/js/libs/DataTables/extensions/ColVis/js/dataTables.colVis.min.js') }}"></script>
<script src="{{ asset('assets/admin/js/libs/DataTables/extensions/TableTools/js/dataTables.tableTools.min.js') }}"></script>
<script src="{{ asset('assets/admin/js/core/demo/DemoTableDynamic.js') }}"></script>
