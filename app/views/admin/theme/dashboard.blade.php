            ...
            <ul class="header-nav header-nav-options">
                <li class="header-nav-brand" >
                    <div class="brand-holder">
                        <a href="#">
                            <span class="text-lg text-bold text-primary">Selim Reza</span>
                        </a>
                    </div>
                </li>
                <li>
                    ...
                    <ul class="dropdown-menu animation-expand">
                        ...
                        <li>
                            <a class="alert alert-callout alert-warning" href="javascript:void(0);">
                                <img src="{{ URL::to('assets/admin/img/avatar2.jpg?1404026449') }}" alt="" >
                        ...
                        <li>
                            <a class="alert alert-callout alert-info" href="javascript:void(0);">
                                <img src="{{ URL::to('assets/admin/img/avatar3.jpg?1404026799') }}" alt="" >
                                ...
                                <ul class="list divider-full-bleed">
                                    <li class="tile">
                                        <div class="tile-content">
                                            <div class="tile-icon">
                                                <img src="{{ URL::to('assets/admin/img/avatar9.jpg?1404026744') }}" alt="" >
                                    ...
                                    <li class="tile">
                                        <div class="tile-content">
                                            <div class="tile-icon">
                                                <img src="{{ URL::to('assets/admin/img/avatar4.jpg?1404026791') }}" alt="" >
                                    ...
                                    <li class="tile">
                                        <div class="tile-content">
                                            <div class="tile-icon">
                                                <img src="{{ URL::to('assets/admin/img/avatar11.jpg?1404026774') }}" alt="" >
                                    ...
                                    <li class="tile">
                                        <div class="tile-content">
                                            <div class="tile-icon">
                                                <img src="{{ URL::to('assets/admin/img/avatar7.jpg?1404026721') }}" alt="" >
                                    ...
                                    <li class="tile">
                                        <div class="tile-content">
                                            <div class="tile-icon">
                                                <img src="{{ URL::to('assets/admin/img/avatar8.jpg?1404026729') }}" alt="" >
            ...
            <div class="offcanvas-body no-padding">
                <ul class="list ">
                    ...
                    <li class="tile">
                        <a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
                            <div class="tile-icon">
                                <img src="{{ URL::to('assets/admin/img/avatar5.jpg?1404026513') }}" alt="" >
                    ...
                    <li class="tile">
                        <a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
                            <div class="tile-icon">
                                <img src="{{ URL::to('assets/admin/img/avatar6.jpg?1404026572') }}" alt="" >
                    ...
                    <li class="tile">
                        <a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
                            <div class="tile-icon">
                                <img src="{{ URL::to('assets/admin/img/avatar10.jpg?1404026762') }}" alt="" >
                ...
                <ul class="list-chats">
                    ...
                    <li class="chat-left">
                        <div class="chat">
                            <div class="chat-avatar">
                                <img src="{{ URL::to('assets/admin/img/avatar9.jpg?1404026744') }}" alt="" >
                                {{--<img class="img-circle" src="../../assets/img/avatar9.jpg?1404026744" alt="" />--}}
                            </div>
                            <div class="chat-body">
