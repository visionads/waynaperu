        ...
        <div class="modal-body">
           ...
           <input type="hidden" name="product_id" value="{{ $product_id }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pdf" name="pdf" placeholder="Price">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="mail" name="mail" placeholder="Price">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="gift" name="gift" placeholder="Price">
