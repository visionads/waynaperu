			...
			<tr>
				<td style="text-align:center;background-color: white; padding: 0 20px ">
					<table width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td>
								<h1>¡Felicitaciones {fullname}!</h1>
							</td>
						</tr>
						<tr>
							<td style="font-size:14px;">
								<p>
									Estas participando por el sorteo <strong>Paintball para dos</strong> por el <strong>Día del Padre </strong> que se sorteara el día <strong>12.06.2016</strong>. 
									<br>Te deseamos suerte.
								</p>
								<p style="text-align:center">
									<img id="publicidad" src="https://www.wayna.com.pe/campaigns/ddp/img/bgemail.jpg" alt="ddp">
								</p>
								<p style="text-align:center">
									El ganador sera publicado en nuestra página de facebook, el día viernes 20 de Mayo a las 9pm.
								</p>
								<p style="text-align:center">
									Saludos,<br>
									Equipo de wayna.
